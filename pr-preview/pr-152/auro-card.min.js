...
`;let g=class e extends b{constructor(){super(),this.variant=void 0,this.privateDefaults();}privateDefaults(){this.uri="https://cdn.jsdelivr.net/npm/@alaskaairux/icons@latest/dist",this.runtimeUtils=new d;}static get properties(){return {...b.properties,ariaHidden:{type:String,reflect:true},category:{type:String,reflect:true},customColor:{type:Boolean,reflect:true},customSvg:{type:Boolean},label:{type:Boolean,reflect:true},name:{type:String,reflect:true},variant:{type:String,reflect:true}}}static get styles(){return [b.styles,f,v,m]}static register(t="auro-icon"){d.prototype.registerComponent(t,e);}connectedCallback(){super.connectedCallback(),this.runtimeUtils.handleComponentTagRename(this,"auro-icon");}exposeCssParts(){this.setAttribute("exportparts","svg:iconSvg");}async firstUpdated(){if(await super.firstUpdated(),this.hasAttribute("ariaHidden")&&this.svg){const e=this.svg.querySelector("desc");e&&(e.remove(),this.svg.removeAttribute("aria-labelledby"));}}render(){const e={labelWrapper:true,util_displayHiddenVisually:!this.label};return x$1`
...
`;class be extends _{constructor(){super(),this._createRefs();const e=new M;this.iconTag=e.generateTag("auro-icon","9.1.0",g);}static get properties(){return {..._.properties}}static get styles(){return [pe,ue,ve]}static get shadowRootOptions(){return {...i$2.shadowRootOptions,delegatesFocus:true}}_createRefs(){this.hyperlinkRef=e();}connectedCallback(){super.connectedCallback(),this.runtimeUtils.handleComponentTagRename(this,"auro-hyperlink");}firstUpdated(){this.hyperlinkRef.value&&(this.attributeWatcher=H({host:this,target:this.hyperlinkRef.value}));}disconnectedCallback(){this.attributeWatcher&&(this.attributeWatcher.cleanup(),this.attributeWatcher=null);}static register(e="auro-hyperlink"){T.prototype.registerComponent(e,be);}renderLayoutDefault(){const e={hyperlink:this.safeUri||this.role,"hyperlink--nav":"nav"===this.type,"hyperlink--ondark":"inverse"===this.appearance||this.ondark,"hyperlink--button":this.role,"hyperlink--secondary":"secondary"===this.variant,"hyperlink--tertiary":"tertiary"===this.variant};return u$1`
    ...
    <a
      ...
      target="${o$3(this.target&&this.includesDomain?this.target:void 0)}"
